...
def _make_exam_result(dose_map: np.ndarray):
    from guiskindose.format_export_data import ExamResult
...
def _suppress_plots():
    ...
    analyze_data_module = importlib.import_module("guiskindose.analyze_data")
    with (
...
class TestAnalyzeMultipleExams:
    ...
    def test_two_exams_return_multi_exam_result(self):
        from guiskindose.analyze_data import analyze_multiple_exams
        from guiskindose.format_export_data import MultiExamResult
...
class TestMultiExamIntegration:
    ...
    def test_multistudy_csv_via_analyze_input_file(self):
        from guiskindose.format_export_data import MultiExamResult
        from guiskindose.main import analyze_input_file
