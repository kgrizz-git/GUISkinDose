...
7. **Phantom library expansion:** agent-executable full-body **true shape** variants via headless MPFB/Blender parametric targets — see [dev-docs/plans/AUTOMATED_PHANTOM_LIBRARY_PLAN.md](dev-docs/plans/AUTOMATED_PHANTOM_LIBRARY_PLAN.md) (Phase 0 spike PASS; Phase 1 `catalog_v1.json` + `run_catalog.py` ready; affine stretch is not the shipping path). Supersedes archived MakeHuman GUI plans.
