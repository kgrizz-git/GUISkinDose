...
| [plans/SETTINGS_EXPORT_PLAN.md](plans/SETTINGS_EXPORT_PLAN.md) | **Active** — reproducible run-state export/import: full GUI state (settings + normalization + per-exam corrections) as versioned JSON; source filenames redacted by default; round-trip acceptance. |
