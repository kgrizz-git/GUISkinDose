...
| [plans/CORRECTION_DATA_PHASE_D_DISTRIBUTION_PROOF_PLAN.md](plans/CORRECTION_DATA_PHASE_D_DISTRIBUTION_PROOF_PLAN.md) | **Active** — Correction-data Phase D: wheel/sdist distribution proof, clean-env install, numerical parity (master §5, last delivery). |
