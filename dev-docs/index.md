...
| [assessments/GUI_NETWORK_EXPOSURE_ASSESSMENT.md](assessments/GUI_NETWORK_EXPOSURE_ASSESSMENT.md) | **DECIDED 2026-09-22** — non-loopback refused outright (no LAN mode); loopback-only threat model + residual risks stand, per-client state deferred to a trigger. Pre-decision mitigation packages kept for the record. |
