...
Regenerate with `python scripts/check_licenses.py --write-notices` (last updated: 2026-06-07).
...
| beautifulsoup4 | 4.14.3 | MIT | Download, https://www.crummy.com/software/BeautifulSoup/bs4/download/ |
| bidict | 0.23.1 | MPL-2.0 | Changelog, https://bidict.readthedocs.io/changelog.html |
| black | 26.5.1 | MIT | Documentation, https://black.readthedocs.io/ |
...
| ipykernel | 7.2.0 | BSD-3-Clause | Homepage, https://ipython.org |
...
| json5 | 0.14.0 | Apache-2.0 | Changelog, https://github.com/dpranke/pyjson5/blob/master/README.md |
...
| jupyter_client | 8.9.0 | BSD-3-Clause | Homepage, https://jupyter.org |
| jupyter_core | 5.9.1 | BSD-3-Clause | Homepage, https://jupyter.org |
| jupyter_server | 2.19.0 | BSD-3-Clause | Homepage, https://jupyter-server.readthedocs.io |
| jupyter_server_terminals | 0.5.4 | BSD-3-Clause | Homepage, https://jupyter.org |
| jupyterlab | 4.5.8 | BSD-3-Clause | Homepage, https://jupyter.org |
...
| mypy_extensions | 1.1.0 | MIT | Homepage, https://github.com/python/mypy_extensions |
...
| nest-asyncio | 1.6.0 | BSD-3-Clause | https://github.com/erdewit/nest_asyncio |
...
| pathspec | 1.1.1 | MPL-2.0 | Change Log, https://python-path-specification.readthedocs.io/en/latest/changes.html |
...
| pytokens | 0.4.1 | MIT | Homepage, https://github.com/tusharsadhwani/pytokens |
...
| ruff | 0.15.16 | MIT | https://docs.astral.sh/ruff |
...
| tornado | 6.5.6 | Apache-2.0 | http://www.tornadoweb.org/ |
...
| wcwidth | 0.8.0 | MIT | Homepage, https://github.com/jquast/wcwidth |
