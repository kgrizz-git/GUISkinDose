...
| --- | --- | --- | --- |
| aiofiles | 25.1.0 | Apache-2.0 | Changelog, https://github.com/Tinche/aiofiles#history |
| aiohappyeyeballs | 2.6.2 | PSF-2.0 | Bug Tracker, https://github.com/aio-libs/aiohappyeyeballs/issues |
| aiohttp | 3.14.1 | MIT | Homepage, https://github.com/aio-libs/aiohttp |
...
| beautifulsoup4 | 4.15.0 | MIT | Download, https://www.crummy.com/software/BeautifulSoup/bs4/download/ |
| bidict | 0.23.1 | MPL-2.0 | Changelog, https://bidict.readthedocs.io/changelog.html |
| bleach | 6.4.0 | Apache-2.0 | https://github.com/mozilla/bleach |
| boltons | 21.0.0 | BSD-3-Clause | https://github.com/mahmoud/boltons |
| boolean.py | 5.0 | BSD-2-Clause | https://github.com/bastikr/boolean.py |
| bottle | 0.13.4 | MIT | http://bottlepy.org/ |
| bracex | 2.6 | MIT | Homepage, https://github.com/facelessuser/bracex |
| CacheControl | 0.14.4 | Apache-2.0 | Homepage, https://pypi.org/project/CacheControl/ |
...
| choreographer | 1.3.0 | MIT, UNKNOWN, MIT, UNKNOWN, UNKNOWN, UNKNOWN, UNKNOWN, UNKNOWN, UNKNOWN | Homepage, https://github.com/plotly/choreographer |
| click | 8.1.8 | BSD-3-Clause | Changes, https://click.palletsprojects.com/changes/ |
| click-option-group | 0.5.9 | BSD-3-Clause | Homepage, https://github.com/click-contrib/click-option-group |
...
| cryptography | 49.0.0 | Apache-2.0, BSD-3-Clause | changelog, https://cryptography.io/en/latest/changelog/ |
...
| face | 26.0.1 | UNKNOWN | Documentation, https://python-face.readthedocs.io/ |
| fastapi | 0.136.3 | MIT | Homepage, https://github.com/fastapi/fastapi |
| fastjsonschema | 2.21.2 | BSD-3-Clause | https://github.com/horejsek/python-fastjsonschema |
| filelock | 3.29.1 | MIT | Documentation, https://py-filelock.readthedocs.io |
| frozenlist | 1.8.0 | Apache-2.0 | https://github.com/aio-libs/frozenlist |
| glom | 25.12.0 | BSD-3-Clause | https://github.com/mahmoud/glom |
| googleapis-common-protos | 1.75.0 | Apache-2.0 | Repository, https://github.com/googleapis/google-cloud-python/tree/main/packages/googleapis-common-protos |
...
| ipykernel | 7.3.0 | BSD-3-Clause | Homepage, https://ipython.org |
| ipython | 9.14.1 | BSD-3-Clause | Homepage, https://ipython.org |
| ipython_pygments_lexers | 1.1.1 | BSD-3-Clause | Source, https://github.com/ipython/ipython-pygments-lexers |
| ipywidgets | 8.1.8 | BSD-3-Clause | http://jupyter.org |
...
| jupyter-events | 0.12.1 | BSD-3-Clause | Homepage, http://jupyter.org |
| jupyter-lsp | 2.3.1 | BSD-3-Clause | Bug Tracker, https://github.com/jupyter-lsp/jupyterlab-lsp/issues |
...
| mdit-py-plugins | 0.6.1 | MIT | Documentation, https://mdit-py-plugins.readthedocs.io |
...
| myst-parser | 5.1.0 | MIT | Documentation, https://myst-parser.readthedocs.io |
...
| numpy-stl | 3.2.0 | BSD-3-Clause | https://github.com/WoLpH/numpy-stl/ |
| openpyxl | 3.1.5 | MIT | https://openpyxl.readthedocs.io |
| opentelemetry-api | 1.37.0 | Apache-2.0 | Homepage, https://github.com/open-telemetry/opentelemetry-python/tree/main/opentelemetry-api |
| opentelemetry-exporter-otlp-proto-common | 1.37.0 | Apache-2.0 | Homepage, https://github.com/open-telemetry/opentelemetry-python/tree/main/exporter/opentelemetry-exporter-otlp-proto-common |
| opentelemetry-exporter-otlp-proto-http | 1.37.0 | Apache-2.0 | Homepage, https://github.com/open-telemetry/opentelemetry-python/tree/main/exporter/opentelemetry-exporter-otlp-proto-http |
| opentelemetry-instrumentation | 0.58b0 | Apache-2.0 | Homepage, https://github.com/open-telemetry/opentelemetry-python-contrib/tree/main/opentelemetry-instrumentation |
| opentelemetry-instrumentation-requests | 0.58b0 | Apache-2.0 | Homepage, https://github.com/open-telemetry/opentelemetry-python-contrib/tree/main/instrumentation/opentelemetry-instrumentation-requests |
| opentelemetry-instrumentation-threading | 0.58b0 | Apache-2.0 | Homepage, https://github.com/open-telemetry/opentelemetry-python-contrib/instrumentation/opentelemetry-instrumentation-threading |
| opentelemetry-proto | 1.37.0 | Apache-2.0 | Homepage, https://github.com/open-telemetry/opentelemetry-python/tree/main/opentelemetry-proto |
| opentelemetry-sdk | 1.37.0 | Apache-2.0 | Homepage, https://github.com/open-telemetry/opentelemetry-python/tree/main/opentelemetry-sdk |
| opentelemetry-semantic-conventions | 0.58b0 | Apache-2.0 | Homepage, https://github.com/open-telemetry/opentelemetry-python/tree/main/opentelemetry-semantic-conventions |
| opentelemetry-util-http | 0.58b0 | Apache-2.0 | Homepage, https://github.com/open-telemetry/opentelemetry-python-contrib/tree/main/util/opentelemetry-util-http |
| orjson | 3.11.9 | Apache-2.0, MIT | changelog, https://github.com/ijl/orjson/blob/master/CHANGELOG.md |
| packageurl-python | 0.17.6 | MIT | https://github.com/package-url/packageurl-python |
| packaging | 26.2 | Apache-2.0, BSD-2-Clause | Documentation, https://packaging.pypa.io/ |
| pandas | 3.0.3 | BSD-3-Clause | homepage, https://pandas.pydata.org |
| pandas-stubs | 3.0.3.260530 | BSD-3-Clause | Bug Tracker, https://github.com/pandas-dev/pandas-stubs/issues |
| pandoc | 2.4 | MIT | MIT License |
| pandocfilters | 1.5.1 | BSD-3-Clause | http://github.com/jgm/pandocfilters |
| parso | 0.8.7 | MIT | https://github.com/davidhalter/parso |
| peewee | 3.19.0 | UNKNOWN | Repository, https://github.com/coleifer/peewee |
| pexpect | 4.9.0 | ISC | https://pexpect.readthedocs.io/ |
| pillow | 12.3.0 | MIT-CMU | Release notes, https://pillow.readthedocs.io/en/stable/releasenotes/index.html |
...
| ply | 3.11 | BSD-3-Clause | http://www.dabeaz.com/ply/ |
| pre_commit | 4.6.0 | MIT | https://github.com/pre-commit/pre-commit |
| prometheus_client | 0.25.0 | Apache-2.0, BSD-2-Clause | Homepage, https://github.com/prometheus/client_python |
| prompt_toolkit | 3.0.52 | BSD-3-Clause | Homepage, https://github.com/prompt-toolkit/python-prompt-toolkit |
| propcache | 0.5.2 | Apache-2.0 | https://github.com/aio-libs/propcache |
| protobuf | 6.33.6 | BSD-3-Clause | https://developers.google.com/protocol-buffers/ |
| proxy_tools | 0.1.0 | MIT | http://github.com/jtushman/proxy_tools |
| psutil | 7.2.2 | BSD-3-Clause | https://github.com/giampaolo/psutil |
| ptyprocess | 0.7.0 | ISC | https://github.com/pexpect/ptyprocess |
| pure_eval | 0.2.3 | MIT | http://github.com/alexmojaki/pure_eval |
| py-serializable | 2.1.0 | Apache-2.0 | Bug Tracker, https://github.com/madpah/serializable/issues |
...
| pydantic-settings | 2.14.2 | MIT | Homepage, https://github.com/pydantic/pydantic-settings |
...
| pyobjc-core | 12.2 | MIT | https://github.com/ronaldoussoren/pyobjc |
| pyobjc-framework-Cocoa | 12.2 | MIT | https://github.com/ronaldoussoren/pyobjc |
| pyobjc-framework-Quartz | 12.2 | MIT | https://github.com/ronaldoussoren/pyobjc |
| pyobjc-framework-Security | 12.2 | MIT | https://github.com/ronaldoussoren/pyobjc |
| pyobjc-framework-UniformTypeIdentifiers | 12.2 | MIT | https://github.com/ronaldoussoren/pyobjc |
| pyobjc-framework-WebKit | 12.2 | MIT | https://github.com/ronaldoussoren/pyobjc |
...
| pytest-cov | 7.1.0 | MIT | Sources, https://github.com/pytest-dev/pytest-cov |
...
| python-json-logger | 4.1.0 | BSD-2-Clause | Homepage, https://nhairs.github.io/python-json-logger |
...
| pywebview | 6.2.1 | BSD-3-Clause | Homepage, https://pywebview.flowrl.com/ |
...
| rfc3986-validator | 0.1.1 | MIT | https://github.com/naimetti/rfc3986-validator |
| rich | 15.0.0 | MIT | Documentation, https://rich.readthedocs.io/en/latest/ |
| roman-numerals | 4.1.0 | 0BSD, CC0-1.0 | Changelog, https://github.com/AA-Turner/roman-numerals/blob/master/CHANGES.rst |
| rpds-py | 2026.5.1 | MIT | Documentation, https://rpds.readthedocs.io/ |
...
| sphinxcontrib-devhelp | 2.0.0 | BSD-3-Clause | Changelog, https://github.com/sphinx-doc/sphinxcontrib-devhelp/blob/master/CHANGES.rst |
| sphinxcontrib-htmlhelp | 2.1.0 | BSD-3-Clause | Changelog, https://github.com/sphinx-doc/sphinxcontrib-htmlhelp/blob/master/CHANGES.rst |
| sphinxcontrib-jquery | 4.1 | BSD-3-Clause | Repository, https://github.com/sphinx-contrib/jquery/ |
| sphinxcontrib-jsmath | 1.0.1 | BSD-3-Clause | http://sphinx-doc.org/ |
...
| sse-starlette | 3.4.5 | BSD-3-Clause | Homepage, https://github.com/sysid/sse-starlette |
...
| wcmatch | 8.5.2 | MIT | Homepage, https://github.com/facelessuser/wcmatch |
...
| widgetsnbextension | 4.0.15 | BSD-3-Clause | http://jupyter.org |
| wrapt | 1.17.3 | BSD-3-Clause | https://github.com/GrahamDumpleton/wrapt |
| wsproto | 1.3.2 | MIT | Homepage, https://github.com/python-hyper/wsproto/ |
