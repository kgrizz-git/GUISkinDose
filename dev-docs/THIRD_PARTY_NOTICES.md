...
Regenerate with `python scripts/check_licenses.py --write-notices` (last updated: 2026-06-08).
...
| docutils | 0.23 | BSD-3-Clause, GPL-2.0-or-later | Changelog, https://docutils.sourceforge.io/HISTORY.html |
