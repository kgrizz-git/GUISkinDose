...
| [pypdf](https://github.com/py-pdf/pypdf) | active | 6.16.2 | local and GitHub Actions | Bounded PDF validation/page counting and text/metadata admission checks | Extracted content is scanned in-process and values are suppressed |
