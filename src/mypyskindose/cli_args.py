"""CLI argument parser construction for mypyskindose.
...
from mypyskindose.cli_kerma_meter import add_kerma_meter_cli_arguments
from mypyskindose.constants import RUN_ARGUMENTS_MODE_GUI, RUN_ARGUMENTS_MODE_HEADLESS
...
def _add_top_level_args(parser: argparse.ArgumentParser) -> None:
    ...
    ``python -m mypyskindose --mode gui --native`` keeps working without a
