...
class NormalizationSettings:
    ...
    Attributes
    ----------
    trans_offset : guiskindose.settings.translation_offset.TranslationOffset
        See class variables of _TranslationOffset
    trans_dir : guiskindose.settings.translation_direction.TranslationDirection
        See class variables of _TranslationDirection
    rot_dir : guiskindose.settings.rotation_direction.RotationDirection
